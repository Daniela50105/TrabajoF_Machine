...
history = model_nn.fit(X_train, y_train, epochs=10, batch_size=32, validation_split=0.2, callbacks=[early_stopping])
...
# Modelo 4: Support Vector Regressor
...
# Comparar modelos
models = {
    'Red Neuronal': (model_nn, mse_nn, r2_nn),
...
if best_model_name == 'Red Neuronal':
    y_pred_best = model_nn.predict(X_test).flatten()
elif best_model_name == 'Bosque Aleatorio':
